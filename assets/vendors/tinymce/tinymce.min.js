...
!function () {
    ...
    /**
         ...
         */
    function Uy(e) { return function (t) { for (var n = arguments.length, o = new Array(n > 1 ? n - 1 : 0), r = 1; r < n; r++)o[r - 1] = arguments[r]; return Ey(e, t, o) } } function zy(e, t) {
        let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : Ay; py &&
            // Make 'in' and truthy checks like Boolean(set.constructor)
            // independent of any properties defined on Object.prototype.
            // Prevent prototype setters from intercepting set as a this value.
            py(e, null); let o = t.length; for (; o--;) {
...
/**
    ...
    const mC = function () { return "undefined" == typeof window ? null : window }; var fC = function e() {
        let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : mC(); const n = t => e(t); if (n.version = "3.2.4", n.removed = [], !t || !t.document || 9 !== t.document.nodeType || !t.Element)
...
/* Parsing of strict XHTML documents */let Se = null; const _e = ["application/xhtml+xml", "text/html"]; let ke = null, Ne = null;
        ...
        const Re = o.createElement("form"), Ae = function (e) { return e instanceof RegExp || e instanceof Function }, Te = function () {
            let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}; if (!Ne || Ne !== e) {
                if (
...
/* Add tbody to ALLOWED_TAGS in case tables are permitted, see #286, #365 */, F.table && (zy(F, ["tbody"]), delete $.tbody), e.TRUSTED_TYPES_POLICY) {
                    if ("function" != typeof e.TRUSTED_TYPES_POLICY.createHTML) throw Iy('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.'); if ("function" != typeof e.TRUSTED_TYPES_POLICY.createScriptURL) throw Iy('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');
            ...
            Ny(n.removed, { element: e }); try {
                // eslint-disable-next-line unicorn/prefer-dom-node-remove
                C(e).removeChild(e)
            } catch (t) { b(e) }
        }, De = function (e, t) {
            try { Ny(n.removed, { attribute: t.getAttributeNode(e), from: t }) } catch (e) { Ny(n.removed, { attribute: null, from: t }) }
            // We void attribute values for unremovable "is" attributes
            if (t.removeAttribute(e), "is" === e) if (ee || te) try { Pe(t) } catch (e) { } else try { t.setAttribute(e, "") } catch (e) { }
        }, Le = function (e) {
            /* Create a HTML document */
            let t = null, n = null; if (J) e = "<remove></remove>" + e; else {
                /* If FORCE_BODY isn't used, leading whitespace needs to be preserved manually */
                const t = Oy(e, /^[\r\n\t ]+/); n = t && t[0]
            } "application/xhtml+xml" === Se && be === he && (
...
/* Use createHTMLDocument in case DOMParser is not available */if (!t || !t.documentElement) {
            ...
            return S.call(e.ownerDocument || e, e,
...
/* Execute a hook if present */, Ue(R.afterSanitizeElements, e, null), !1) : (Pe(e), !0)
        }, je = function (e, t, n) {
...
/* Allow valid data-* attributes: At least one character after "-"
            ...
            We don't need to check the value; it's always URI safe. */if (W && !V[t] && My(B, t)); else if (q && My(P, t)); else if (!z[t] || V[t]) {
                if (
...
} else if (me[t]); else if (My(I, By(n, L, ""))); else if ("src" !== t && "xlink:href" !== t && "href" !== t || "script" === e || 0 !== Py(n, "data:") || !ce[e]) if (K && !My(D, By(n, L, ""))); else if (n) return !1; return !0
...
/* Go backwards over all attributes; safely remove bad ones */for (; r--;) {
                const s = t[r], { name: a, namespaceURI: i, value: l } = s, d = ke(a); let c = "value" === a ? l : Dy(l); const u = c;
                /* Execute a hook if present */
...
/* Clean up removed elements */, n.removed = [],
                ...
                if (e.nodeName) { const t = ke(e.nodeName); if (!F[t] || $[t]) throw Iy("root node is forbidden and cannot be sanitized in-place") }
...
/* Return sanitized string or DOM */if (ee) {
                if (te) for (d = _.call(o.ownerDocument); o.firstChild;)
                    // eslint-disable-next-line unicorn/prefer-dom-node-append
...
/* Sanitize final string template-safe */, G && Sy([A, T, O], (e => { u = By(u, e, " ") })), w && ne ? w.createHTML(u) : u
