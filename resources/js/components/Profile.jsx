            ...
            <div className="pagetitle">
                ...
                <nav>
                    <ol className="breadcrumb">
                        <li className="breadcrumb-item"><a href="https://bootstrapmade.com/content/demo/NiceAdmin/index.html">Home</a></li>
                                ...
                                <div className="tab-content pt-2">
                                    <div className="tab-pane fade show active profile-overview" id="profile-overview">
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-lg-9 col-md-8"><a href="https://bootstrapmade.com/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="a1ca8fc0cfc5c4d3d2cecfe1c4d9c0ccd1cdc48fc2cecc">[email&#160;protected]</a></div>
                                        </div>
                                    </div>
                                        ...
                                        <form>
                                            <div className="row mb-3">
                                                ...
                                                <div className="col-md-8 col-lg-9">
                                                    <img src="https://bootstrapmade.com/content/demo/NiceAdmin/assets/img/profile-img.jpg" alt="Profile" />
                                                    <div className="pt-2">
